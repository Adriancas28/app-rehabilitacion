        ...
        when {
            ...
            uiState.resultado == null -> Box(
                ...
                Column(
                    ...
                    TarjetaPorcentaje(resultado.porcentajeEjecucion, resultado.desviacionPromedio)
...
@Composable
private fun TarjetaPorcentaje(porcentajeEjecucion: Float, desviacionPromedio: Float) {
    Card(
        ...
        Row(
            ...
            Box(modifier = Modifier.size(64.dp), contentAlignment = Alignment.Center) {
                CircularProgressIndicator(
                    progress = { (porcentajeEjecucion / 100f).coerceIn(0f, 1f) },
                    modifier = Modifier.size(64.dp),
                    strokeWidth = 6.dp,
                    trackColor = MaterialTheme.colorScheme.surfaceVariant,
                )
                Text(
                    text = "${porcentajeEjecucion.toInt()}%",
                    style = MaterialTheme.typography.labelLarge,
                )
            }
            Spacer(modifier = Modifier.width(16.dp))
            Column {
                Text(text = "Ejecución dentro del rango", style = MaterialTheme.typography.titleMedium)
                Text(
                    text = "Desviación promedio: ${"%.1f".format(desviacionPromedio)}°",
